...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Саамский языковой приз северных стран выделяется  осенью 2014 г.'"/>
    <!--
    ...
    <xsl:variable name="top_margin" select="'9=11'"/>
    <xsl:variable name="bottom_margin" select="'9=32'"/>
