...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.ostersund.se/download/18.3e11750b14ae81c49054df/1421235417645/Ryska.pdf'"/>
    ...
    <language xml:lang="rus"/><language xml:lang="swe"/></xsl:variable>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="engelska.pdf"/>
