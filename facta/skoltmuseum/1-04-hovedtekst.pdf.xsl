...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <language xml:lang="rus"/><language xml:lang="nob"/><language xml:lang="fin"/><language xml:lang="eng"/><language xml:lang="sms"/></xsl:variable>
    ...
    <xsl:variable name="top_margin" select="'1=70, 2=5'"/>
    <xsl:variable name="bottom_margin" select="'1=15, 2=85'"/>
